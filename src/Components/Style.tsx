...
export class Prompt extends React.Component<{
    ...
    render() {
        return (
            <PromptEl style={this.props.style} onKeyPress={e => this.handleKeypress(e)}>
                {this.props.children}
            </PromptEl>
        );
    }
...
export const ExprRow = styled.div<{ borderless?: boolean; highlight?: boolean; noFill?: boolean }>`
    display: flex;
...
export class OperandEl extends React.Component<IOperandElProps> {
    ...
    render() {
        const { color, bold, italic, noFocus, order, children, tooltip, highlight } = this.props;
        return (
            <>
                <OperandText
                    tabbable={!noFocus}
    ...
    private renderEditor() {
        return <div>{this.props.children.editor!(() => (this.isOpen = false))}</div>;
    }
    private handleClick() {
