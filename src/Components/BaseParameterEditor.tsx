...
import { OperandTextEl, OperandEl, OperandText, colors, Prompt, PromptFooter } from './Style';
...
> {
    ...
    render() {
        return this.dep.builder.viewOnly() ? (
            <OperandTextEl color={colors.text.brown} highlight={this.dep.highlight.expr === this.props.model}>
                {this.props.getText ? this.props.getText() : this.getText()}
            </OperandTextEl>
        ) : (
            <OperandEl color={colors.text.brown} highlight={this.dep.highlight.expr === this.props.model}>
                {{
    ...
    private getEditor(close: () => void): React.ReactNode {
        ...
        return (
            ...
            >
                {this.props.getEditorBody ? this.props.getEditorBody(this.wrapper) : this.getEditorBody(this.wrapper)}
                <PromptFooter>
                    <Button onClick={submit}>Ok</Button>
                    <Button onClick={close}>Cancel</Button>
                    <OperandText tooltip="Remove Static Value" onClick={this.props.remove}>
...
@observer
export default class DefaultValueEditor extends React.Component<IExprComponent<Parameter> & IReplaceableExpr> {
    render() {
