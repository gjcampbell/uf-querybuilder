...
@observer
export default class OperatorEditor extends DiComponent<IOperatorElProps, IConfigAccessor> {
    render() {
        ...
        return (
            <Prompt>
                <FilterableTree
                    ...
                    onNodeClick={(op: UfOperator) => this.handleOperatorSelected(op, close)}
                />
            </Prompt>
        );
    }
    ...
    private getText() {
        return this.props.operator ? this.props.operator.ufName : '[Nothing Selected]';
    }
}
