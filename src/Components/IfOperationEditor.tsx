...
@observer
export class IfOperationEditor extends DiComponent<
  IExprComponent<IfOperation>,
  IConfigAccessor
> {
  render() {
          ...
          <ExprRow>
            {condition
              ? this.dep.builder.editorFactory.renderExpr(condition, {
                  remove: () =>
                    this.doUpdate(
                      () => (this.props.model.condition = undefined)
                    )
                })
          ...
          <ExprRow>
            ...
            {ifTrue
              ? this.dep.builder.editorFactory.renderExpr(ifTrue, {
                  update: (e: IExpression) =>
                    this.doUpdate(() => (this.props.model.ifTrue = e)),
                  remove: () =>
                    this.doUpdate(() => (this.props.model.ifTrue = undefined))
                })
          ...
          <ExprRow>
            ...
            {ifFalse
              ? this.dep.builder.editorFactory.renderExpr(ifFalse, {
                  update: (e: IExpression) =>
                    this.doUpdate(() => (this.props.model.ifFalse = e)),
                  remove: () =>
                    this.doUpdate(() => (this.props.model.ifFalse = undefined))
                })
