...
const renderReplaceableExpr = (model: IExpression, update: (model: IExpression) => void, moreProps?: any) => {
...
const renderValueEditor = (model: IExpression, opposite?: IExpression, operator?: OpIds, moreProps?: any) => {
...
const ValueEditorFactory = (operator?: OpIds, oppositeOperand?: IExpression) => {
    const typeHint = oppositeOperand && oppositeOperand.getValueType ? oppositeOperand.getValueType() : undefined;
    switch (operator) {
        case OpIds.In:
