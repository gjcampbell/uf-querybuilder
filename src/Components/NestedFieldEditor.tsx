...
@observer
export class NestedFieldEditor extends DiComponent<
  IExprComponent<NestedFieldModel> & IReplaceableExpr,
  IConfigAccessor & IFieldsAccessor & IHighlightAccessor
> {
  render() {
    const tooltip =
      this.props.model.getName() !== this.props.model.getFullName()
        ? `Full Name: ${this.props.model.getFullName()}`
        : undefined;
